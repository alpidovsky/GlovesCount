# GlovesCount
Программа GlovesCount решает задачу про белые и черные перчатки в мешке, написана на Java и является консольным приложением. Запускается с помощью файла GlovesCount.cmd.
